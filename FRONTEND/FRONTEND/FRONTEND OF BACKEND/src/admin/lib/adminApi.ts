...
export const adminApi = {
  ...
  async getApprovals(): Promise<ApprovalsResponse> {
    const response = await apiRequest.get<ApiResponse<ApprovalsResponse>>(
      '/admin/approvals'
    );
  ...
  async approveCreditRequest(
    id: number,
    data: CreditRequestDecisionRequest
  ): Promise<void> {
  ...
  async deleteUser(id: number): Promise<void> {
    const response = await apiRequest.delete<ApiResponse<void>>(
      `/admin/users/${id}`
    );
    if (!response.data.success) {
      throw new Error(response.data.message);
  ...
  async getRoleByKey(key: string): Promise<Role> {
    const response = await apiRequest.get<ApiResponse<Role>>(
      `/admin/roles/${key}`
    );
    return response.data.data;
  },
  ...
  async createRole(data: CreateRoleRequest): Promise<Role> {
    const response = await apiRequest.post<ApiResponse<Role>>(
      '/admin/roles',
      data
    );
    return response.data.data;
  ...
  async getCompanies(): Promise<Company[]> {
    const response = await apiRequest.get<ApiResponse<Company[]>>(
      '/companies'
    );
    return response.data.data;
  },
  ...
  async createCompany(data: Partial<Company>): Promise<Company> {
    const response = await apiRequest.post<ApiResponse<Company>>(
      '/companies',
      data
    );
    return response.data.data;
  ...
  async updateCompany(id: number, data: Partial<Company>): Promise<Company> {
    const response = await apiRequest.put<ApiResponse<Company>>(
      `/companies/${id}`,
      data
    );
    return response.data.data;
  ...
  async getSettings(): Promise<AdminSettings> {
    const response = await apiRequest.get<ApiResponse<AdminSettings>>(
      '/admin/settings'
    );
    return response.data.data;
  },
  ...
  async updateSettings(data: Partial<AdminSettings>): Promise<AdminSettings> {
    const response = await apiRequest.put<ApiResponse<AdminSettings>>(
      '/admin/settings',
      data
    );
    return response.data.data;
