        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[var(--color-surface-secondary)]">
                  ...
                  <th className="text-right text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-tertiary)] px-3 py-2.5 w-[15%]">Rate (₹)</th>
                  ...
                  <th className="text-right text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-tertiary)] px-3 py-2.5 w-[18%]">Amount (₹)</th>
          ...
          <div className="sm:hidden space-y-3">
            {lines.map((line, idx) => (
              <div key={line.id} className="border border-[var(--color-border-default)] rounded-xl p-3 space-y-2">
                ...
                {line.amount > 0 && (
                  <p className="text-right text-[13px] font-medium tabular-nums text-[var(--color-text-primary)]">₹{fmt(line.amount)}</p>
                )}
              </div>
            ))}
          </div>
          ...
          <div className="border-t border-[var(--color-border-subtle)] pt-3 space-y-1.5 max-w-[240px] ml-auto">
            ...
            <div className="flex justify-between text-[12px]">
              ...
              <span className="tabular-nums text-[var(--color-text-secondary)]">₹{fmt(totals.tax)}</span>
            </div>
