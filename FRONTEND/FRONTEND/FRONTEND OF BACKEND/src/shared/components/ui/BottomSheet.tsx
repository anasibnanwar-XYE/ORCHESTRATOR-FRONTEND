    ...
    <div className="fixed inset-0 z-[var(--z-modal)]">
      ...
      <div
        className={clsx(
          ...
          isClosing ? 'animate-[fadeOut_250ms_ease-out_forwards]' : 'animate-[fadeIn_200ms_ease-out_forwards]',
        )}
      ...
      <div
        className={clsx(
          desktopMode === 'modal' && 'hidden sm:flex items-center justify-center h-full p-4',
        )}
      >
        {desktopMode === 'modal' && (
          <div
      ...
      <div
        ...
        style={{
          ...
          transition: dragRef.current.isDragging ? 'none' : 'transform 300ms cubic-bezier(0.22, 1, 0.36, 1)',
