...
const STYLES = `
  ...
  @media (min-width: 901px) and (max-width: 1200px) {
    .lp-form-wrap { margin-left: 60px !important; width: 320px !important; }
    .lp-brand-block { margin-top: 240px !important; max-width: 320px !important; }
    .lp-brand { padding: 0 40px !important; }
    .lp-quote { left: 40px !important; }
  }
...
export function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <>
      ...
      <main
        className="lp-shell"
        style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: 'minmax(400px, 38%) minmax(0,1fr)' }}
      >
        {/* ── Brand panel (dark) ── */}
        <section
          className="lp-brand"
        ...
        >
          ...
          <blockquote
            className="lp-quote"
            style={{ position: 'absolute', left: 60, bottom: 60, maxWidth: 360, color: 'var(--color-neutral-500)', margin: 0, padding: 0 }}
          >
