...
/**
 * PullToRefresh — touch pull-down gesture to reload data.
 * Shows a spinner indicator while refresh is in progress.
      ...
      <div
        ...
        style={{
          ...
          transition: dragRef.current.isDragging
            ? 'none'
            : 'height 300ms cubic-bezier(0.22, 1, 0.36, 1), opacity 200ms',
        }}
      >
        <div
          className={clsx(
