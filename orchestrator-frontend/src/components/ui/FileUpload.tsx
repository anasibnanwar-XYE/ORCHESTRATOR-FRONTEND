    ...
    <div className={twMerge('space-y-1.5', className)}>
      ...
      >
        ...
        <p className="text-[13px] text-[var(--color-text-primary)] font-medium mb-1">
          Click to upload{' '}
          <span className="font-normal text-[var(--color-text-tertiary)]">or drag and drop</span>
        </p>
      ...
      {files.length > 0 && (
        <div className="space-y-2 mt-3">
          {files.map((file, i) => (
            <div
              key={i}
              className="flex items-center justify-between p-2.5 bg-[var(--color-surface-primary)] border border-[var(--color-border-default)] rounded-lg"
            >
              ...
              <button
                ...
                className="p-1.5 text-[var(--color-text-tertiary)] hover:text-[var(--color-error)] rounded-md hover:bg-[var(--color-error-bg)] transition-colors shrink-0"
              >
                <X size={14} />
              </button>
            </div>
