          ...
          >
            ...
            {!isLast && (
              <div
                className={clsx(
                  ...
                  isCompleted && 'bg-[var(--color-neutral-900)]',
                )}
              />
            )}
            ...
            <div
              className={clsx(
                ...
                isCompleted
                  ? 'bg-[var(--color-neutral-900)] border-[var(--color-neutral-900)] text-[var(--color-text-inverse)]'
                  : isCurrent
                    ? 'bg-[var(--color-surface-primary)] border-[var(--color-neutral-900)] text-[var(--color-neutral-900)]'
            ...
            {/* Step Text */}
            <div
              className={clsx(orientation === 'horizontal' ? 'mt-3 px-2' : 'pb-8 pt-1')}
            >
              <div
                className={clsx(
