...
Frontend portal planning (deep):
- Portal index: `docs/portals/INDEX.md`
- Portal master plan (6 portals including superadmin overlay): `docs/portals/PORTAL_FRONTEND_MASTER_PLAN.md`
- Endpoints grouped by portal (OpenAPI + code-only deltas): `docs/portals/PORTAL_ENDPOINTS_BY_PORTAL.md`
