  ...
  *
  * Sections:
  *  1. KPI stat cards: Total Tenants, Active, Suspended, Platform Users, Storage
  *  2. Quick actions to navigate to tenant management, roles, audit, tickets
  *
  * Data source:
  *  - superadminDashboardApi.getMetrics() — aggregated from /companies + /admin/users
  */
 ...
 import type { PlatformDashboardMetrics } from '@/types';
 ...
 export function SuperadminDashboardPage() {
   ...
   const deactivatedTenants =
     metrics != null
       ? metrics.totalTenants - metrics.activeTenants - metrics.suspendedTenants
       : 0;
           ...
           {isLoading ? (
             ...
             <>
               <MetricCard
                 ...
                 description={deactivatedTenants > 0 ? `${deactivatedTenants} deactivated` : 'All registered tenants'}
                 icon={<Building2 size={15} />}
               ...
               <MetricCard
                 ...
                 value={metrics?.totalPlatformUsers ?? 0}
               ...
               <MetricCard
                 label="Storage Used"
                 value={formatStorage(metrics?.storageConsumption ?? 0)}
