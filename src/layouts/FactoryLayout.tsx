...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    title: 'Production',
    items: [
      { label: 'Plans', to: '/factory/production/plans', icon: Factory },
      { label: 'Production Logs', to: '/factory/production/logs', icon: ClipboardList },
      { label: 'Batches', to: '/factory/production/batches', icon: Layers },
    ],
  },
  {
    title: 'Packing & Dispatch',
    items: [
      { label: 'Packing', to: '/factory/packing', icon: PackageCheck },
