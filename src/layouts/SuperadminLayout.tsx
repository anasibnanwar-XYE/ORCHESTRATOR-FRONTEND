...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Portal Insights', to: '/superadmin/portal-insights', icon: Globe },
  { label: 'Tenant Runtime', to: '/superadmin/tenant-runtime', icon: Server, module: MODULE_KEYS.SUPERADMIN_RUNTIME },
  { label: 'Operations Control', to: '/superadmin/operations-control', icon: Sliders },
...
const ROUTE_LABELS: Record<string, string> = {
  ...
  '/superadmin/portal-insights': 'Portal Insights',
  '/superadmin/tenant-runtime': 'Tenant Runtime',
  '/superadmin/runtime': 'Tenant Runtime',
  '/superadmin/operations-control': 'Operations Control',
